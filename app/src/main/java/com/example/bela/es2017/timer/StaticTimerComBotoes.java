...
public class StaticTimerComBotoes {
    ...
    static TimerComBotoes.CountDownState state = TimerComBotoes.CountDownState.UNINITIALIZED;
    ...
    private static FloatingActionButton startStopBtn,resetBtn;
    public static CountDownTimer cTimer = null;
    static CountDownTimer alertTimer;
    private int mPageNumber;
    public static long passoTime;
    ViewGroup c;
    Activity act;
    ...
    public StaticTimerComBotoes(ViewGroup rootView, Activity act, long initTime) {
        ...
        if (cTimer == null) {
            ...
            if (state == TimerComBotoes.CountDownState.RUNNING) {
        ...
        if (cTimer != null) {
            ...
            startStopBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    switch (state) {
                        case UNINITIALIZED:changeState(TimerComBotoes.CountDownState.RUNNING);break;
                        case RUNNING:changeState(TimerComBotoes.CountDownState.PAUSED);break;
                        case PAUSED:changeState(TimerComBotoes.CountDownState.RUNNING);break;
                        case FINISHED:changeState(TimerComBotoes.CountDownState.UNINITIALIZED);break;
                        default:break;
                    }
                }
            });
